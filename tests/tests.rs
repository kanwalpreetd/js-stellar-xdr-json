...
fn decode_iter_success() {
    assert_eq!(
        ...
        Ok([r#"{"function_v0":{"doc":"","name":"initialize","inputs":[{"doc":"","name":"token_wasm_hash","type":{"bytes_n":{"n":32}}},{"doc":"","name":"token_a","type":"address"},{"doc":"","name":"token_b","type":"address"}],"outputs":[]}}"#,
            r#"{"function_v0":{"doc":"","name":"share_id","inputs":[],"outputs":["address"]}}"#,
            r#"{"function_v0":{"doc":"","name":"deposit","inputs":[{"doc":"","name":"to","type":"address"},{"doc":"","name":"desired_a","type":"i128"},{"doc":"","name":"min_a","type":"i128"},{"doc":"","name":"desired_b","type":"i128"},{"doc":"","name":"min_b","type":"i128"}],"outputs":[]}}"#,
            r#"{"function_v0":{"doc":"","name":"swap","inputs":[{"doc":"","name":"to","type":"address"},{"doc":"","name":"buy_a","type":"bool"},{"doc":"","name":"out","type":"i128"},{"doc":"","name":"in_max","type":"i128"}],"outputs":[]}}"#,
            r#"{"function_v0":{"doc":"","name":"withdraw","inputs":[{"doc":"","name":"to","type":"address"},{"doc":"","name":"share_amount","type":"i128"},{"doc":"","name":"min_a","type":"i128"},{"doc":"","name":"min_b","type":"i128"}],"outputs":[{"tuple":{"value_types":["i128","i128"]}}]}}"#,
